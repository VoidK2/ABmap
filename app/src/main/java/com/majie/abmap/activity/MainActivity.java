...
import com.majie.abmap.adapter.SearchResultRecyclerAdapter;
import com.majie.abmap.base.BaseActivity;
import com.majie.abmap.fragment.AmapFragment;
import com.majie.abmap.fragment.BaiduMapFragment;
import com.majie.abmap.interacter.ConfigInteracter;
import com.majie.abmap.interacter.FavoriteInteracter;
import com.majie.abmap.model.MyPoiModel;
import com.majie.abmap.model.TypeMap;
import com.majie.abmap.model.TypeNavigation;
import com.majie.abmap.model.TypePoi;
import com.majie.abmap.model.TypeSearch;
import com.majie.abmap.model.User;
import com.majie.abmap.utils.AppUtils;
import com.majie.abmap.utils.DBOpenHelper;
import com.majie.abmap.utils.LogUtils;
import com.majie.abmap.utils.PermissionUtils;
import com.majie.abmap.utils.StatusBarUtils;
import com.majie.abmap.utils.StringUtils;
...
public class MainActivity extends BaseActivity implements View.OnClickListener, NavigationView.OnNavigationItemSelectedListener, SearchResultRecyclerAdapter.OnSelectSearchResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!inSqlLite()){
            Toast.makeText(this, "跳转到登陆界面中", Toast.LENGTH_SHORT).show();
...
//            finish();//销毁此Activity
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        else if (id == R.id.nav_exitAccount) {
//            openActivity(SettingActivity.class);
            mDBOpenHelper.purge();
            Intent intent = new Intent(this, loginActivity.class);
            startActivity(intent);
