...
import com.majie.abmap.adapter.AboutAdapter;
...
//        list.add(new AboutModel("分享给好友", null));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (0 == position) {
            ...
            share(getResources().getString(R.string.app_name), "我正在使用" + getResources().getString(R.string.app_name) + "，双地图应用，一起来试试吧！" + getResources().getString(R.string.link_download));
        }
    }
